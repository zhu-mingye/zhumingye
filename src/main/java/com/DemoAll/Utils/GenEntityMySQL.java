...
public class GenEntityMySQL {
    ...
    private String authorName = "zhumingye";// 作者名字
    private String tablename = "eb_brand";// 表名
    private String packageOutPath = "com.bawei.entity";// 指定实体生成所在包的路径
...
//    private static final String PASS = "tiger";
    private static final String URL="jdbc:mysql://localhost:3306/lianxi04?user=root&password=root&useUnicode=true&characterEncoding=UTF8";
//  private static final String DRIVER = "oracle.jdbc.driver.OracleDriver";
    ...
    public GenEntityMySQL(String tablename,String javaName,String databaseName) {
...
//            return "Date";
    ...
    public static void main(String[] args) {  
        ...
        new GenEntityMySQL("dept","Dept","lianxi04").init();  
        new GenEntityMySQL("doctor","Doctor","lianxi04").init();  
        new GenEntityMySQL("orders","Orders","lianxi04").init();  
        new GenEntityMySQL("users","Users","lianxi04").init();  
        new GenEntityMySQL("works","Works","lianxi04").init();  
    }  
}
